...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'mailing_service_db'),
        'USER': os.getenv('DATABASE_USER', 'mailing_service_user'),
...
DATETIME_INPUT_FORMATS = ['%Y-%m-%d %H:%M:%S', '%d/%m/%Y %H:%M']
...
LOGIN_REDIRECT_URL = '/mailing/clients/'
